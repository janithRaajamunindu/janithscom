...
const BlogBard = ({
  ...
  return (
    ...
    className='relative flex h-[473px] w-[100%] flex-col items-start justify-between rounded-[23px] border-[1px] hover:border-white transition-all
    duration-300 border-[#212531] bg-transparent p-[28px] sm:h-[450px]
